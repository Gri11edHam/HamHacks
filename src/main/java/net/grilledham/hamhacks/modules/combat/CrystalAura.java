...
public class CrystalAura extends Module {
	...
	public CrystalAura() {
		super(new TranslatableText("module.hamhacks.crystalaura"), new TranslatableText("module.hamhacks.crystalaura.tooltip"), Category.COMBAT, new Keybind(GLFW.GLFW_KEY_C));
	}
