...
public class ButtonElement extends GuiElement {
	...
	public ButtonElement(String text, float x, float y, float width, float height, float scale, Runnable onClick) {
	...
	public void render(MatrixStack stack, int mx, int my, float scrollX, float scrollY, float partialTicks) {
		...
		mc.textRenderer.drawWithShadow(stack, text, x + width / 2f - mc.textRenderer.getWidth(text) / 2f, y + height / 2f - mc.textRenderer.fontHeight / 2f, ui.textColor.getRGB());
